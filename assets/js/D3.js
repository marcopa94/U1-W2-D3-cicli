...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const box1 = starWarsCharacters[i];
  const name = box1.name;
  console.log(name);
}
/* ESERCIZIO 3
...
while (p < starWarsCharacters.length) {
  crewMass += starWarsCharacters[p].mass;
  p++;
}
...
} else if (crewMass > 900 && creMass < 1000) {
...
*/
/*leggere tutti i gender 
se n/a consol log nome +"e un robot"
asseGNA  A QUESTI personaggi il valore robot a gender*/
